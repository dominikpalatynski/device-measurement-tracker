...
export default function ExperimentsPage() {
	...
	const filteredExperiments = (() => {
		if (filter === "all") {
			...
			return experiments.filter(
				(experiment) => experiment.mode === filter
			);
		} else {
			return experiments.filter(
				(experiment) => experiment.status === filter
			);
		}
	})();
	...
	const breadcrumbs = [
		{ label: "Home", href: "/" },
		{ label: "Experiments", href: "/experiments", current: true },
	];
				...
				<div className='text-center py-12 bg-gray-50 rounded-lg'>
					...
					<p className='text-gray-500 mb-6'>
						{filter === "all"
							...
							? `Try adjusting your filter or create a new ${filter.toLowerCase()} experiment`
