...
describe('FaultRegisterPage', () => {
  it('should render the fault register page with title', () => {
    ...
    expect(screen.getByRole('heading', { name: /register fault/i })).toBeInTheDocument();
    expect(screen.getByText(/fault registration functionality coming soon/i)).toBeInTheDocument();
  });
