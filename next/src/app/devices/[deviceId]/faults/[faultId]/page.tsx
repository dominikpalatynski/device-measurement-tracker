							...
							<div>
								...
								{liveFault.conditions_count > 0 ? (
									...
									<div className='text-center py-4 text-gray-500'>
										No conditions recorded yet. Add one to
										start measuring specific conditions.
									</div>
								)}
							</div>
						</div>
							...
							{offlineConditions.length > 0 ? (
								...
								<div className='text-center py-6 text-gray-500 bg-gray-50 border border-gray-200 rounded-lg'>
									...
									<div className='text-sm'>
										Create conditions to prepare for data
										upload via scripts.
									</div>
								</div>
							)}
